...
namespace AuxMods
{
    ...
    //Improves HFF's in-game shell (accessed via `~` or `F1`)
    [BepInPlugin("top.zman350x.utility.bettershell", "Better In-Game Shell", "1.0.0")]
    [BepInProcess("Human.exe")]
    class BetterInGameShell : BaseUnityPlugin
    {
        //Patch the Shell upon game startup
        public void Awake()
        {
